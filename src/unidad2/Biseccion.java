//Nombre del paquete
package unidad2;
//Importaci贸n de las librerias java
import java.awt.*;
import javax.swing.*;
import java.io.*;
import clases.*;
...
public class Biseccion{
  ...
  // End of variables declaration//GEN-END:variables
   ...
   int x,y;  //Variables para almacenar la posicion del mouse para el uso de un evento
    ...
    public Biseccion() {                //M茅todo constructor
    ...
    private void initComponents() {
        ...
        //Bot贸n calcular                                                             //Evento al hacer clic en el boton
...
//evento para abrir el menu de unidad 2                                              //Evento al hacer clic en el boton
    ...
    private void btn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn4ActionPerformed
		...
		Float.parseFloat(txt1.getText());
                ...
                Float.parseFloat(txt2.getText());
                btn1.setEnabled(true);                  //habilita el bot贸n para calcular
 ...
 //Evento del boton Ayuda, para el enlace desde el boton hacia el documento propio del metodo       //Evento al hacer clic en el boton
   ...
   public void solucion() {
      ...
      } while (Math.abs(fc) >= error);                              //Condici贸n del ciclo
      txtarea.setText(ms);
   }
   //M茅todo para Validar los valores ingresados
   public void Datos() {
       ...
       if(ban1==false){
           try{
               a=Double.parseDouble(txt1.getText());                                                    //Validaci贸n para que los datos ingresados sean numeros para txt1 y txt2
               ban1=true;                                                                               //
   ...
   //M茅todo para validar la tolerancia de error (Menor a 1)
   public void Error() {
      ...
      try{
          ...
          ban=true;
          if(ban==true){
              if(error>1)                                                                       //Validaci贸n para el valor de la tolerancia de error
                JOptionPane.showMessageDialog(null,"Verificar la toleancia del error");
              else
                solucion();
          }
      }catch(NumberFormatException e){                                                          //Excepci贸n
