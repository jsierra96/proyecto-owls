...
public class serie_taylor{
  ...
  window ventana;
    public serie_taylor() {  //M�todo constructor
     ...
     private void initComponents() {        //se declaran e inicializan todos los componentes a utilizar
        ...
        min4.setForeground(new java.awt.Color(0, 204, 255));    // se configura el color de primer plano utilizado por el método de pintura predeterminado del Componente
        min4.setBorderPainted(false);   //Elimina el color del borde del componente
        min4.setDefaultCapable(false); //elimina la capa por default
        min4.setFocusPainted(false); //elimina el estilo de enfique por defecto
        min4.setFocusable(false);   //Deshabilita el componente 
        ...
        //Personalizacion de los componentes
        jLabel3.setBackground(new Color(51, 204, 0));   //se configura el color de fondo del componente
        jLabel3.setBounds(30, 55, 50, 20);  //configuracion de tamaño y posicion al componente
        jLabel4.setBounds(290, 50, 30, 20); //configuracion de tamaño y posicion al componente
        jLabel5.setBounds(30, 130, 50, 40); //configuracion de tamaño y posicion al componente
        jLabel6.setBounds(30, 190, 50, 45); //configuracion de tamaño y posicion al componente
        jLabel7.setBounds(30, 250, 50, 45); //configuracion de tamaño y posicion al componente
        jLabel8.setBounds(270, 220, 150, 40);   //configuracion de tamaño y posicion al componente
        jLabel9.setBounds(290, 160, 130, 40);   //configuracion de tamaño y posicion al componente
        jLabel10.setBounds(400, 50, 30, 20);    //configuracion de tamaño y posicion al componente
        jLabel18.setBounds(180, 0, 240, 49);    //configuracion de tamaño y posicion al componente
        txt1.setBounds(330, 50, 40, 25);    //configuracion de tamaño y posicion al componente
        txt2.setBounds(430, 170, 85, 30);   //configuracion de tamaño y posicion al componente
        txt3.setBounds(430, 230, 85, 30);   //configuracion de tamaño y posicion al componente
        evaluador1.setBounds(90,50,132,30); //configuracion de tamaño y posicion al componente
        evaluador2.setBounds(90,140,132,30);    //configuracion de tamaño y posicion al componente
        evaluador3.setBounds(90,200,132,30);    //configuracion de tamaño y posicion al componente
        evaluador4.setBounds(90,260,132,30);    //configuracion de tamaño y posicion al componente
        btn1.setBounds(310,100,100,30); //configuracion de tamaño y posicion al componente
        btn2.setBounds(440,100,100,30); //configuracion de tamaño y posicion al componente
        btn3.setBounds(140,320,100,30); //configuracion de tamaño y posicion al componente
        jButton1.setBounds(485,323,90,30);  //configuracion de tamaño y posicion al componente
        txt1.setBackground(new Color(178, 235, 242));   //se configura el color de fondo del componente
        txt2.setBackground(new Color(178, 235, 242));   //se configura el color de fondo del componente
        txt3.setBackground(new Color(178, 235, 242));   //se configura el color de fondo del componente
        txt4.setBackground(new Color(178, 235, 242));   //se configura el color de fondo del componente
        jLabel8.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 153));   // se configura el color de primer plano utilizado por el método de pintura predeterminado del Componente
        jLabel8.setText("Porcentaje de error:");    //Configura el texto a mostrar
        jLabel9.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 153));   // se configura el color de primer plano utilizado por el método de pintura predeterminado del Componente
        jLabel9.setText("Serie de Taylor :");   //Configura el texto a mostrar
        ...
        txt4.setBounds(440,50,40,25);   //configuracion de tamaño y posicion al componente
        btn3.setText("Validar");    //Configura el texto a mostrar
        ...
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); //alineacion horizontal
        jLabel18.setText("Serie de Taylor");    //Configura el texto a mostrar
   ...
   //Evento del boton Calcular, envio de la funcion al componente evaluador         //Evento al hacer clic en el boton
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {
        String aux2="";    //Variable para obtener la expresion                                                      
        evaluador1.setvar(Double.parseDouble(txt4.getText())); //Envio de la cadena (Expresion) al componente evaluador
        evaluador1.iniciar1();  //ejecucion del metodo iniciar1() para el componente evaluador1
        String aux=evaluador1.getexpre();   //Variable para obtener la expresion      
        aux2=aux;   //Variable para obtener la expresion      
        evaluador1.iniciar();
        ...
        evaluador4.iniciar();
        serie(); 
        error(aux2); //ejecuta el metodo error enviandole la expresion resuelta
    }
